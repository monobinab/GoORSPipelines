...
public class OrsIssuanceErrorFilterPredicate implements SerializableFunction<List<KV<String, String>>, Boolean> {

	private static final long serialVersionUID = -3359461688360298766L;
