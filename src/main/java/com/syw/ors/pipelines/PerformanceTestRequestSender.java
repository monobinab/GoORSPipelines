...
public class PerformanceTestRequestSender {
	...
	public static interface PerformanceTestRequestSenderOptions extends
			PipelineOptions {
		@Description("URL")
	...
	public static void main(String[] args) {
		...
		PipelineOptionsFactory
				.register(PerformanceTestRequestSenderOptions.class);
		PerformanceTestRequestSenderOptions options = PipelineOptionsFactory
				.fromArgs(args).withValidation()
				.as(PerformanceTestRequestSenderOptions.class);
		Pipeline p = Pipeline.create(options);

		p.apply(BigQueryIO.Read.named(
				"ClientRequestsPull" + options.getRequestDate()).from(
				"syw-ors-1226:ors_logs.ors_client_requests_"
						+ options.getRequestDate())).apply(
